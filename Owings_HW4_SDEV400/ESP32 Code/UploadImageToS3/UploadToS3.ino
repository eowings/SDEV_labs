...
const char* ssid = "FiOS-0JJX3-Guest";
const char* password = "P@ssWord";
int capture_interval = 90000; // Microseconds between captures
...
static esp_err_t take_send_photo()
{
  ...
  //  Invoke URL from API Gateway in "" Folder name in S3 followed by name of jpg file.
  String post_url2 = "https://pyavq8z0td.execute-api.us-east-1.amazonaws.com/one/" + MAC + "/" + Time;
